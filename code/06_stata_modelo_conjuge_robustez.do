...
log using "D:/rayne/Documents/dados_econometria_VI/model_conj_terceira_entrevista.log", replace
...
merge m:m new_id using "${data_folder}/chefe_merge_info_entrev_3.dta"
...
psmatch2 treated, out(renda_deflac) pscore(_ps) neighbor(1) bw(0.06) common
...
*ssc install psmatch2
psmatch2 treated_2, out(renda_deflac) pscore(_ps_2) neighbor(1) bw(0.06) common
...
*ssc install psmatch2
psmatch2 treated_3, out(renda_deflac) pscore(_ps_3) neighbor(1) bw(0.06) common
