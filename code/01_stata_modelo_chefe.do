...
psmatch2 treated , out(renda_deflac) pscore(_ps) neighbor(1) caliper(0.0005) bw(0.06) common
...
*ssc install diff
*Realiza o psm para depois rodar o diff in diff
logit treated i.idade i.cor i.UF i.educ i.tri i.ano
predict _ps, pr
...
*ssc install psmatch2
psmatch2 treated, out(renda_deflac) pscore(_ps) neighbor(1) caliper(0.002) bw(0.06) common
...
*ssc install diff
*Realiza o psm para depois rodar o diff in diff
logit treated_2 i.idade i.cor i.UF i.educ i.tri i.ano
predict _ps_2, pr
...
*ssc install psmatch2
psmatch2 treated_2, out(renda_deflac) pscore(_ps_2) neighbor(1) caliper(0.002) bw(0.06) common
...
*ssc install diff
*Realiza o psm para depois rodar o diff in diff
logit treated_3 i.idade i.cor i.UF i.educ i.tri i.ano  
predict _ps_3, pr
...
log using "D:/rayne/Documents/dados_econometria_VI/model_chefe_INDUSTRIA.log", replace
...
log using "D:/rayne/Documents/dados_econometria_VI/model_chefe_CONSTRUCAO.log", replace
...
*ssc install psmatch2
psmatch2 treated_2, out(renda_deflac) pscore(_ps_2) neighbor(1) caliper(0.0008) bw(0.06) common
...
*ssc install psmatch2
psmatch2 treated_3, out(renda_deflac) pscore(_ps_3) neighbor(1) caliper(0.0008) bw(0.06) common
...
*e administrativas
keep if grup_ativ ==4 | grup_ativ ==5 | grup_ativ ==6 | grup_ativ ==7 | grup_ativ ==10
...
*ssc install psmatch2
psmatch2 treated, out(renda_deflac) pscore(_ps) neighbor(1) caliper(0.00004) bw(0.06) common
