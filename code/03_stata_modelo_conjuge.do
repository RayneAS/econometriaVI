...
log using "D:/rayne/Documents/dados_econometria_VI/model_conj_SETOR_PRIMARIO.log", replace
...
*ssc install diff
*Realiza o psm para depois rodar o diff in diff
logit treatedi.UF i.idade_chefe i.grup_ativ_chefe i.educ_chefe i.cor_chefe i.rural
predict _ps, pr
...
*ssc install diff
*Realiza o psm para depois rodar o diff in diff
logit treated_2i.UF i.idade_chefe i.grup_ativ_chefe i.educ_chefe i.cor_chefe i.rural
predict _ps_2, pr
...
pstesti.UF i.idade_chefe i.grup_ativ_chefe i.educ_chefe i.cor_chefe i.rural , graph
...
*ssc install diff
*Realiza o psm para depois rodar o diff in diff
logit treated_3i.UF i.idade_chefe i.grup_ativ_chefe i.educ_chefe i.cor_chefe i.rural
predict _ps_3, pr
...
log using "D:/rayne/Documents/dados_econometria_VI/model_conj_INDUSTRIA_E_CONSTRUCAO.log", replace
...
log using "D:/rayne/Documents/dados_econometria_VI/model_conj_COMERCIO_E_SERVICOS.log", replace
